...
Main program
    ...
    while not run:
        print(
            "\nHello my name is Zach and this program is used to demonstrate "
            "different python operations.")
        print(
            "The \"+\" operator is used for both add numbers and concatenating"
            " strings together.")
        print(
            "\nThis first example you will enter strings and python will conca"
            "tenate them together using the \"+\" operator.")
        str0 = input("Enter a word: ")
        str1 = input("Enter another word: ")
        print("\"" + str0 + str1 + "\"")

        print(
            "\nThe next example will use the \"sep=\" function to separate "
            "each string that was used on the first example.")
        sep1 = input("Enter something to separate the first example with: ")
        print(str0, str1, sep=sep1)
        print(
            "\nThis next example you will enter a word and a number. Python wi"
            "ll then print that word however many times you tell it to.")
        ...
        print(
            "\nThis next example you will enter two numbers and python will ad"
            "d them together using the \"+\" operator.")
        ...
        print(
            "\nThe next example will be using the \"-\" operator to subtract t"
            "he two numbers.")
        print("Enter a number that is an integer: ")
        num3 = integer_input()
        print("Enter another number that is an integer: ")
        ...
        print(
            "\nThe next example will be using the \"/\" operator to divide two"
            " numbers.")
        print("Enter a number that is an integer: ")
        div1 = integer_input()
        print("Enter another number that is an integer: ")
        ...
        print(
            "\nThe next example will be using the \"//\" operator which divide"
            "s two numbers using floor division.")
        print("Enter a number that is an integer: ")
        ...
        print(
            "\nThe next example will use the \"*\" operator to multiply two nu"
            "mbers together.")
        print("Enter a number that is an integer: ")
        mult1 = integer_input()
        print("Enter another number that is an integer: ")
        ...
        print(
            "\nThis final example will use the \"**\" operator to take a numbe"
            "r to an exponent.")
        print("Enter a number that is an integer: ")
        num5 = integer_input()
        ...
        print(
            "\nThe next example will look at the boolean operator \"==\" that "
        ...
        print(
            "\nThe next example will look at another boolean operator \"!=\" t"
            "hat compares to values to see if they are not equal.")
        print("Enter a number that is an integer: ")
        num8 = integer_input()
        print("Enter another number that is an integer: ")
        num9 = integer_input()
        ...
        print(
            "\nThe next example will look at another boolean operator \">\" to"
        ...
        print(
            "If you would like to use the demonstration again then enter \"yes"
